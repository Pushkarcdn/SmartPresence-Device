...
import All from "@/components/admin/employers/All";
...
export default function Applications() {
  ...
  const {
    ...
    fetchData: refetchemployers,
  } = useFetch("/employers") as any;
  ...
  const tabs = {
    All: <All data={filtered} refetch={refetchemployers} />,
  } as any;
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {employersLoading && <Loader />}
      {!employersLoading && tabs[currentTab]}
    </div>
  );
}
